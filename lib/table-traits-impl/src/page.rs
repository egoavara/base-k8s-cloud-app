...
impl<T: Cursor> InputType for PageByCursor<T> {
    ...
    fn to_value(&self) -> async_graphql::Value {
        ...
        map.insert(Name::new("after"), InputType::to_value(&self.after));
        map.insert(Name::new("before"), InputType::to_value(&self.before));
        map.insert(Name::new("first"), InputType::to_value(&self.first));
        map.insert(Name::new("last"), InputType::to_value(&self.last));
